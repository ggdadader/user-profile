  ...
  <html>
   ...
   <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        ...
        <div>
            <span style="color: white;margin-right: 10px;">Hi, root@example.com</span>
            <a href="/users/1" style="color: white;margin-right: 10px;">Profile</a>
...
<ul class="nav nav-pills">
  <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link " href="?categoryId=1">中式料理</a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="?categoryId=2">日本料理</a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="?categoryId=3">義大利料理</a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="?categoryId=4">墨西哥料理</a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="?categoryId=5">素食料理</a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="?categoryId=6">美式料理</a>
    </li>
    <li class="nav-item">
      <a class="nav-link " href="?categoryId=7">複合式料理</a>
    </li>
</ul>
<br>
<div class="row">
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=34.28664124510033" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <p class="card-text">Enim velit dolores in.</p>
            <form action="/favorite/1?_method=DELETE" method="POST"><button type="submit" class="btn btn-danger float-left mr-2">移除最愛</button></form>
            <form action="/like/1" method="POST"><button type="submit" class="btn btn-primary">Like</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=80.20150144403091" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <span class="badge badge-secondary">中式料理</span>
          <p class="card-text">Expedita asperiores qui. Possimus rerum amet vel v</p>
            <form action="/favorite/2" method="POST"><button type="submit" class="btn btn-primary float-left mr-2">加到最愛</button></form>
            <form action="/like/2?_method=DELETE" method="POST"><button type="submit" class="btn btn-danger">Unlike</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=16.04765635982797" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <span class="badge badge-secondary">義大利料理</span>
          <p class="card-text">Error dicta est vitae at voluptatem.</p>
            <form action="/favorite/3?_method=DELETE" method="POST"><button type="submit" class="btn btn-danger float-left mr-2">移除最愛</button></form>
            <form action="/like/3" method="POST"><button type="submit" class="btn btn-primary">Like</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=1.7593104092412881" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <p class="card-text">et</p>
            <form action="/favorite/4?_method=DELETE" method="POST"><button type="submit" class="btn btn-danger float-left mr-2">移除最愛</button></form>
            <form action="/like/4" method="POST"><button type="submit" class="btn btn-primary">Like</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=28.32250437970567" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <span class="badge badge-secondary">素食料理</span>
          <p class="card-text">omnis</p>
            <form action="/favorite/5" method="POST"><button type="submit" class="btn btn-primary float-left mr-2">加到最愛</button></form>
            <form action="/like/5?_method=DELETE" method="POST"><button type="submit" class="btn btn-danger">Unlike</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=95.36316738677164" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <span class="badge badge-secondary">日本料理</span>
          <p class="card-text">Delectus et ea exercitationem recusandae delectus </p>
            <form action="/favorite/6" method="POST"><button type="submit" class="btn btn-primary float-left mr-2">加到最愛</button></form>
            <form action="/like/6" method="POST"><button type="submit" class="btn btn-primary">Like</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=25.279235663053367" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
            <a href="/restaurants/7">
              Mrs. Terrance Goldner
            </a>
          </p>
          <span class="badge badge-secondary">素食料理</span>
          <p class="card-text">fuga</p>
            <form action="/favorite/7" method="POST"><button type="submit" class="btn btn-primary float-left mr-2">加到最愛</button></form>
            <form action="/like/7?_method=DELETE" method="POST"><button type="submit" class="btn btn-danger">Unlike</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=42.66778164759013" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <span class="badge badge-secondary">墨西哥料理</span>
          <p class="card-text">Qui aliquid itaque itaque et ut recusandae velit q</p>
            <form action="/favorite/8" method="POST"><button type="submit" class="btn btn-primary float-left mr-2">加到最愛</button></form>
            <form action="/like/8" method="POST"><button type="submit" class="btn btn-primary">Like</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=47.59333981051594" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <span class="badge badge-secondary">日本料理</span>
          <p class="card-text">Voluptas hic at rem. Similique occaecati libero re</p>
            <form action="/favorite/9" method="POST"><button type="submit" class="btn btn-primary float-left mr-2">加到最愛</button></form>
            <form action="/like/9" method="POST"><button type="submit" class="btn btn-primary">Like</button></form>
        </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <img class="card-img-top" src="https://loremflickr.com/320/240/restaurant,food/?random=21.281958268620492" alt="Card image cap" width="286px" height="180px">
        <div class="card-body">
          <p class="card-text">
          ...
          <span class="badge badge-secondary">中式料理</span>
          <p class="card-text">rerum enim rerum</p>
            <form action="/favorite/10" method="POST"><button type="submit" class="btn btn-primary float-left mr-2">加到最愛</button></form>
            <form action="/like/10" method="POST"><button type="submit" class="btn btn-primary">Like</button></form>
        </div>
      </div>
    </div>
</div>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="page-item">
      <a class="page-link" href="/restaurants?page=1&amp;categoryId=" aria-label="Previous">
        <span aria-hidden="true">«</span>
      </a>
    </li>
        <li class="page-item active"><a class="page-link" href="#">1</a></li>
      <li class="page-item"><a class="page-link" href="/restaurants?page=2&amp;categoryId=">2</a></li>
      <li class="page-item"><a class="page-link" href="/restaurants?page=3&amp;categoryId=">3</a></li>
      <li class="page-item"><a class="page-link" href="/restaurants?page=4&amp;categoryId=">4</a></li>
      <li class="page-item"><a class="page-link" href="/restaurants?page=5&amp;categoryId=">5</a></li>
    <a class="page-link" href="/restaurants?page=2&amp;categoryId=" aria-label="Next">
      <span aria-hidden="true">»</span>
    </a>
